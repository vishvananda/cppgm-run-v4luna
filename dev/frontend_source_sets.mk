...
FRONTEND_OBJ_BASENAMES_ppexpr := preprocess/pptoken preprocess/control_expression postprocess/posttoken
FRONTEND_OBJ_BASENAMES_preproc := preprocess/pptoken preprocess/control_expression preprocess/preprocessor postprocess/posttoken
FRONTEND_OBJ_BASENAMES_cppgm++ := preprocess/pptoken preprocess/control_expression preprocess/preprocessor postprocess/posttoken parser/ast_tokens parser/ast_name_state parser/ast parser/ast_printer parser/ast_parser parser/ast_functional_type semantic/pa6 semantic/pa7_ast semantic/pa7_lookup semantic/pa7_templates semantic/pa7
